...
func init() {
	...
	//   4719: AuditPolicy被更改 (High危，CloseMonitor)
	//   4672: 特殊Permission分配 (High危，提权)
	//   4765, 4766: SID History 操作 (跨域提权后门)
	//   4794: 尝试Settings DSRM (DirectoryServiceResume模式) Password
...
func mapCriticalEvents(unmapped map[string]interface{}, entry *ocsf.VSentryOCSFEvent) {
	...
	switch eventID {
	case 1102: // Log被清空 - .CategoryName = ocsf.CategoryFindings
	...
	case 4719: // AuditPolicy更改 - .CategoryName = ocsf.CategorySystem
